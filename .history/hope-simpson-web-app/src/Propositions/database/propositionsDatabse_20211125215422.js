const propositions = [
  {
    ...
    images: 
      { title: 'Norway - Lat: 60.4720, Long: 8.4689', src: '/captures/prop4/Norway.png' },
      { title: 'Florida - Lat: 27.6648, Long: 81.5158', src: '/captures/prop4/FL.png' },
      { title: 'Georgia - Lat: 32.1656, Long: 82.9001', src: '/captures/prop4/GA.png' },
  ...
  {
    title: 'Propositions4',
    description: 'Concerning Covid-19 viral epidemics that occur "out of season"',
    explanations: [
      {
  ...
  {
    title: 'Propositions6',
    description: 'Concerning the diminishing and increasing of cases of respiratory viruses between successive seasons.',
    explanations: [
      {
        key: 'Local cases have been seen to rise and fall around the world',
        sup: []
